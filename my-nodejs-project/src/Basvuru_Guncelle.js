...
function Basvuru_Guncelle() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3001/applyUpdate',
            ...
            if (response.status === 200) {
                ...
                setPassport('');
                setLetter('');
                setSuccess('Your application has been updated. You can see your application from your profile.');
...
export default Basvuru_Guncelle;